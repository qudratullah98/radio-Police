          ...
          <!--end::Menu wrapper-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu">
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
                                ...
                                <span class="menu-title">{{ __('header.light') }}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
                                ...
                                <span class="menu-title">{{ __('header.dark') }}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                                ...
                                <span class="menu-title">{{ __('header.system') }}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="{{ route('locale', ['locale' => 'da']) }}" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
                                <span class="menu-icon" data-kt-element="icon">

                                </span>
                                <span class="menu-title">دری</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            ...
                            <a href="{{ route('locale', ['locale' => 'pa']) }}" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
                                <span class="menu-icon" data-kt-element="icon">

                                </span>
                                <span class="menu-title">پشتو</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        {{-- <div class="menu-item px-3 my-0">
              <a href="{{ route('locale', ['locale' => 'en']) }}" class="menu-link px-3 py-2" data-kt-element="mode"
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ asset(Auth::user()->photo == null ? 'assets/media/avatars/blank.png' : 'storage/users/' . Auth::user()->photo) }}" alt="User profile picture">
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    {{-- <img alt="Logo" src="{{asset('assets/emarat_logo.png')}}" /> --}}
                                    <img src="{{ asset(Auth::user()->photo == null ? 'assets/media/avatars/blank.png' : 'storage/users/' . Auth::user()->photo) }}" alt="User profile picture">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('profile') }}" class="menu-link px-5">{{ __('header.my_profile') }}</a>
                        </div>
                        <!--end::Menu item-->
